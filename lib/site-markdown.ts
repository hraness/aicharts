...
export function agentGuideMarkdown(
  ...
  return joinMarkdown([
    ...
    "",
    `AI Charts publishes dated snapshots; the benchmark owners create the measurements. The older coding-agent source view covers ${summary.recordCount} configurations and is only one part of the atlas.`,
    "",
    "## Main pages",
    "",
