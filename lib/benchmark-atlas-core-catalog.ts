...
export const CORE_ATLAS_ENTRIES = [
  ...
  {
    id: "aa-terminal-bench-4",
    name: "Terminal-Bench 4 · AA evaluation",
    version: "4.0",
    category: "coding",
    question: "How did these coding configurations perform on terminal tasks?",
    summary: "Terminal-Bench 4 results retained inside the Artificial Analysis coding-suite comparison.",
    source: codingSource,
    measure: "Task success on Terminal-Bench 4 with the named agent and model.",
    comparisonRule: "Keep this Artificial Analysis cohort separate from the standalone owner-published Terminal-Bench 4 cohort.",
    limitations: [
      "Cost and time cover the AA coding suite, not this isolated benchmark.",
      "The checked source does not report per-configuration uncertainty.",
    ],
    coverage: "charted",
    tags: ["terminal", "coding", "agents"],
  },
  {
    id: "swe-atlas",
    name: "SWE-Atlas-QnA",
