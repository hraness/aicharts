  ...
  return <>
    ...
    <main className="usage-home usage-home--stats" id="main-content">
      ...
      {configuration.available ? <>
        {privateStatsEnabled() ? <StatsDashboard todayUtcDay={configuration.todayUtcDay} remoteEnabled startWithAccount returnTo="/dashboard" variant="overview"
          account={<UsageAccountControl returnTo="/dashboard" />} lead={<UsageTotalsPanel returnTo="/dashboard" />}
          fallback={<DailyUsageDashboard todayUtcDay={configuration.todayUtcDay} returnTo="/dashboard" />} />
          : <><UsageAccountControl returnTo="/dashboard" /><DailyUsageDashboard key={configuration.todayUtcDay} todayUtcDay={configuration.todayUtcDay} returnTo="/dashboard" /></>}
