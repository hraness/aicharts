...
3. Evidence: exact benchmark and methodology searches such as MirrorCode, SlopCodeBench, SWE-bench, Terminal-Bench, Terminal-Bench-Science, and questions about what a result does or does not establish.
