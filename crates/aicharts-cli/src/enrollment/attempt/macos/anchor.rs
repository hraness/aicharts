//! Existing explicit anchors only, following custody reference traversal rules.
//! Retain every descriptor/name edge; paths never establish enrollment authority.
use super::*;
