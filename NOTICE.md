...
AI Charts includes a normalized snapshot of publicly displayed benchmark facts sourced from the [Artificial Analysis coding agents page](https://artificialanalysis.ai/agents/coding-agents/) and a discovery-only snapshot of public model metadata sourced from the [OpenRouter Models API](https://openrouter.ai/docs/api/api-reference/models/get-models). Artificial Analysis and OpenRouter are not affiliated with or responsible for AI Charts.
