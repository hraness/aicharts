...
- **Status:** Partial source only: local Worker tooling and numeric-only R2 staging implemented and locally runtime-tested; account-owned enrollment and fixed R2 namespace-anchor source added. Authenticated admission remains unimplemented and disabled.
- **Depends on:** 0, 1
