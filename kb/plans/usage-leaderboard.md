...
- **Status:** Partial: browser registration, dormant server boundary and internal pairing lifecycle delivered. Fresh-authentication coordinator source is implemented; device enrollment and profile extensions remain unimplemented.
- **Depends on:** 0
