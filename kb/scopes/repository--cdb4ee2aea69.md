...
The root `AGENTS.md` is the repository's normative control plane. Its rules apply before deeper lookup. AI Charts is a standalone deployable product for sourced model and agent comparisons, with chart behavior and checked benchmark data owned in this repository.
