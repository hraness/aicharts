  ...
  return (
    <section aria-labelledby="home-editorial-title" className="home-editorial">
      <div className="home-editorial__heading">
        <div>
          <h2 id="home-editorial-title">Benchmark analysis</h2>
          <p>Three sourced guides to cost, trust, and long-horizon work.</p>
        </div>
          ...
          return (
            <article key={slug}>
              <Link aria-label={article.title} href={blogArticlePath(slug)}>
                <EditorialFigure image={blogEditorialImage(slug)} variant="card" />
              </Link>
              <h3>
