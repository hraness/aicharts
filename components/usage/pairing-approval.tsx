...
export function PairingApprovalPanel({ view, read, decide, navigating }: Readonly<{
  ...
  return <section className="usage-pairing" aria-labelledby="pairing-title">
    ...
    <aside className="usage-pairing__privacy" aria-label="What connecting allows">
      <h2>Numeric usage only</h2><p>The collector publishes numeric usage from the coding agents and AI clients you select. Prompts, responses, and session transcripts stay out of uploads. Public sharing is a separate choice.</p>
    </aside>
  </section>;
}
