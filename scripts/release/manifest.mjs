...
const SKILL_FILES = Object.freeze(["BUILD.json", "LICENSE", "NOTICE.md", "SKILL.md", "agents/openai.yaml", "references/benchmarks.md", "references/local-operations.md", "references/local-turns.md", "references/local-usage.md", "scripts/atlas.check.mjs", "scripts/support.mjs", "scripts/support-foundation.mjs", "scripts/support.check.mjs", "references/support.md", "THIRD_PARTY_NOTICES.md", "scripts/atlas.mjs"]);
